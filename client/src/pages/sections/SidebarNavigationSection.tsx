...
const primaryNavItems = [
  {
    label: "Log Meal",
    iconSrc: "/figmaAssets/container-15.svg",
    active: false,
    destructive: false,
  },
  {
    label: "Dashboard",
    iconSrc: "/figmaAssets/container-13.svg",
    active: false,
    destructive: false,
  },
  {
  ...
  {
    label: "Insights",
    iconSrc: "/figmaAssets/container-14.svg",
    active: false,
    destructive: false,
  },
  {
    label: "Profile",
    iconSrc: "/figmaAssets/container-1.svg",
    active: false,
    destructive: false,
  },
];
...
const secondaryNavItems = [
  ...
  {
    label: "Logout",
    iconSrc: "/figmaAssets/container.svg",
    destructive: true,
  },
];
    ...
    <aside className="flex h-full min-h-screen w-full max-w-72 flex-col gap-2 overflow-y-auto border-r border-[#b1b3a94c] bg-[#fafaf3] p-6">
      ...
      <nav aria-label="Primary" className="flex flex-col gap-2">
        {primaryNavItems.map((item) => (
          ...
          >
            <img className="shrink-0" alt="" src={item.iconSrc} />
            <span
              className={`[font-family:'Plus_Jakarta_Sans',Helvetica] text-base leading-6 ${
                item.active
                  ? "font-bold text-[#005c15]"
                  : "font-semibold text-[#5d6058]"
              }`}
            >
              {item.label}
            </span>
